...
export const translations = {
  en: {
    ...
    'guide.description': 'Follow these steps to successfully add your project to chileanWare.',
    'guide.step1.title': 'Fork the repository',
    'guide.step1.desc': 'Go to the chileanWare repo on GitHub and click the **Fork** button to create a copy in your account.',
    'guide.step2.title': 'Clone your fork',
    'guide.step2.desc': 'Clone the forked repo to your machine:',
    'guide.step2.code': 'git clone https://github.com/<your-user>/chileanWare.git',
    'guide.step3.title': 'Create a branch',
    'guide.step3.desc': 'Create a new branch from `develop`:',
    'guide.step3.code': 'git checkout develop\ngit checkout -b feat/add-my-project',
    'guide.step4.title': 'Add your .md file',
    'guide.step4.desc': 'Create a file `my-project.md` inside `src/content/projects/`. Use lowercase and hyphens for the name.',
    'guide.step5.title': 'Fill in the frontmatter',
    'guide.step5.desc': 'Make sure your file includes all required fields. The format will be automatically validated.',
    'guide.step6.title': 'Commit and push',
    'guide.step6.desc': 'Stage, commit and push your changes:',
    ...
    'guide.step7.desc': 'Go to GitHub, click **"Compare & pull request"** and make sure it targets the `develop` branch.',
    'guide.step8.title': 'Wait for validation',
    'guide.step8.desc': 'Our automated checks will validate your file format. If everything is correct, a maintainer will review and merge your PR.',
    'guide.rules.title': 'Validation rules',
    'guide.rules.desc': 'Your .md file will be automatically checked for:',
    ...
    'guide.rule6': 'featured and sponsor must be false',
    ...
    'guide.tip': 'Tip: Run the project locally with `npm run dev` to preview your project before submitting.',
  ...
  es: {
    ...
    'guide.description': 'Sigue estos pasos para agregar tu proyecto a chileanWare exitosamente.',
    'guide.step1.title': 'Haz fork del repositorio',
    'guide.step1.desc': 'Ve al repo de chileanWare en GitHub y haz clic en el botón **Fork** para crear una copia en tu cuenta.',
    'guide.step2.title': 'Clona tu fork',
    'guide.step2.desc': 'Clona el repo forkeado en tu máquina:',
    'guide.step2.code': 'git clone https://github.com/<tu-usuario>/chileanWare.git',
    'guide.step3.title': 'Crea una branch',
    'guide.step3.desc': 'Crea una nueva branch desde `develop`:',
    'guide.step3.code': 'git checkout develop\ngit checkout -b feat/add-mi-proyecto',
    'guide.step4.title': 'Agrega tu archivo .md',
    'guide.step4.desc': 'Crea un archivo `mi-proyecto.md` dentro de `src/content/projects/`. Usa minúsculas y guiones para el nombre.',
    'guide.step5.title': 'Completa el frontmatter',
    'guide.step5.desc': 'Asegúrate de que tu archivo incluya todos los campos requeridos. El formato se valida automáticamente.',
    'guide.step6.title': 'Commit y push',
    'guide.step6.desc': 'Agrega, commitea y sube tus cambios:',
    ...
    'guide.step7.desc': 'Ve a GitHub, haz clic en **"Compare & pull request"** y asegúrate de que apunte a la branch `develop`.',
    'guide.step8.title': 'Espera la validación',
    'guide.step8.desc': 'Nuestros checks automáticos validarán el formato de tu archivo. Si todo está correcto, un maintainer revisará y hará merge de tu PR.',
    'guide.rules.title': 'Reglas de validación',
    'guide.rules.desc': 'Tu archivo .md será verificado automáticamente:',
    ...
    'guide.rule6': 'featured y sponsor deben ser false',
    ...
    'guide.tip': 'Tip: Ejecuta el proyecto localmente con `npm run dev` para previsualizar tu proyecto antes de enviar.',
